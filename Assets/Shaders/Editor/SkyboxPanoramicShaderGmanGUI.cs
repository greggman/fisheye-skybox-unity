...
{
    internal class SkyboxPanoramicShaderGmanGUI : ShaderGUI
    {
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
        {
            ...
            m_ShowLatLongLayout.target = ShowProp(materialEditor, FindProperty("_Mapping", props)) > 0;
            ...
            ShowProp(materialEditor, FindProperty("_Debug", props));
